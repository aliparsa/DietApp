...
/**
 * Created by Alip on 8/6/2015.
 */
public class ServerAddress {
   // public static String serverAddress = "http://192.168.0.5:85";
 //   public static String serverAddress = "http://irdevelopers.ir";
   ...
   // public static String skyFolder= serverAddress+"/sky/";
    ...
    //public static String TarahiWebUrl ="http://www.skyecommerce.ir/page/tarahi.htm";
    //public static String SpanserUrl="http://www.skyecommerce.ir/page/sponser.htm";
    //public static String CheraAsemanWebUrl="http://www.skyecommerce.ir/page/websky.htm";
